...
public class BulkOperations {
    public static void main(String[] args) {
        ...
        list.removeAll( Arrays.asList(3,5,8) );// remove cikartir 3 5 8 i yazdirmdi
        ...
        numbers.retainAll(Arrays.asList(100, 200, 300)); // retain ise sadece sectigimiz sayilari yazdirir.
