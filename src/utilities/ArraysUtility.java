...
public class ArraysUtility {
        ...
        //bir tamsayı dizisinin her bir tamsayısını ayrı satırlarda yazdırır
    ...
    //bir çift dizinin her bir çiftini ayrı satırlarda yazdırır
    ...
    //char dizisinin her bir karakterini ayrı satırlarda yazdırır
    ...
    //String dizisinin her bir String'ini ayrı satırlarda yazdırır
    ...
    // tamsayı dizisinden maksimum sayıyı döndürür
    ...
    //çift diziden maksimum sayıyı döndürür
   ...
   // tamsayı dizisinden minimum sayıyı döndürür
    ...
    //çift diziden minimum sayıyı döndürür
    ...
    //verilen tamsayının verilen dizide olup olmadığını kontrol eder. boolean döndürür. içerir(int[], int)
    ...
    public static boolean contains(int[] array, int element){
        ...
        for (int each : array) {
            if(each == element){ // if any array's element is matching with the given element, it means the given elements is contained in the array
                                 // herhangi bir dizinin elemanı verilen elemanla eşleşiyorsa, bu verilen elemanların dizide yer aldığı anlamına gelir
                result = true;
            }
        }
    ...
    //verilen double'ın verilen dizi içinde olup olmadığını kontrol eder. boole döndürür.
    ...
    //verilen karakterin verilen dizide olup olmadığını kontrol eder. boole döndürür.
    ...
    //verilen String'in verilen dizide yer alıp almadığını kontrol eder. boole döndürür.
