...
public class UnaryOperators {
    public static void main(String[] args) {
        ...
        System.out.println(c++); // 100 post increment: first passes the current value, the increases the value by 1
        ...
        int y = 200;
        System.out.println(y--); // 200 post increment: first passes the current value, the decreases the value by 1
